...
The place for additional C++ files that are used in connection with [HRaw].
...
// TODO define "some files" want to know excact
...
Oh, and samples that will be played through the streaming engine, will obviously also use this system. 
